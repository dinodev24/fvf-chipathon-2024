...
C {devices/vdd.sym} -470 -30 0 0 {name=l3 lab=VDD}
...
value=".tran 0.1n 1u
.save all"}
C {devices/isource.sym} -410 0 0 0 {name=I0 value=1u}
...
C {devices/lab_pin.sym} -410 -30 1 0 {name=p5 sig_type=std_logic lab=Ib}
